...
InfiniteRunner.draw = function(){
  ...
  this.fillText('REKOR: '+this.jumpCountRecord, this.width - (150 + (this.aceleration * 4)), 33 - (this.aceleration * 4));
  this.fillStyle = this.scoreColor;
  this.font = (12 + (this.aceleration * 3))+'pt Arial';
  this.fillText('LOMPATAN: '+this.jumpCount, this.width - (150 + (this.aceleration * 4)), 50);
